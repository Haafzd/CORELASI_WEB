  const schedules = {
    ...
    selasa: [
      { pelajaran: "Fisika", waktu: "08.00", kelas: "IPA 1" }
    ],
    rabu: [
      { pelajaran: "Kimia", waktu: "09.00", kelas: "IPA 1" }
    ],
    kamis: [
    ...
    jumat: [
      { pelajaran: "Olahraga", waktu: "07.30", kelas: "Semua" }
    ],
    sabtu: [
      { pelajaran: "Seni Budaya", waktu: "09.00", kelas: "IPA 1" }
    ]
  };
